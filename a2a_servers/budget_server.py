...
app = build_app(spec=SPEC, runner=run_budget_specialist)


def main() -> None:
    run_specialist_server(spec=SPEC, runner=run_budget_specialist, program_name="python -m a2a_servers.budget_server")
